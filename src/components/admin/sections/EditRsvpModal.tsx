            ...
            {editingRow ? (
                <>
                    ...
                    <div className="mt-5 overflow-x-auto">
                        ...
                        <button
                            className="mt-3 inline-flex min-h-11 cursor-pointer items-center justify-center gap-2 rounded-md border border-taupe/30 bg-white px-4 py-2 text-sm font-medium text-ink transition hover:bg-cream"
                            type="button"
                            onClick={() =>
                                setEditingRow((value) =>
                                    value
                        ...
                        <div className="mt-6 space-y-5 border-t border-taupe/15 pt-5">
                            ...
                            <div>
                                <div className="flex items-center justify-between gap-3">
                                    ...
                                    <button
                                        className="inline-flex min-h-10 cursor-pointer items-center justify-center gap-2 rounded-md border border-taupe/30 bg-white px-3 py-2 text-sm font-medium text-ink transition hover:bg-cream"
                                        type="button"
                                        onClick={() =>
                                            setEditingRow((value) => {
