...
export const siteContent = {
  ...
  hero: {
    ...
    image:
      "https://images.unsplash.com/photo-1513278974582-3e1b4a4fa21e?auto=format&fit=crop&w=2000&q=88",
  ...
  events: [
    {
      ...
      startTime: "11:00",
      endTime: "14:00",
      venueName: "Church venue to be confirmed",
      address: "Add church address here",
      attire: "Smart casual, church wear",
      description:
  ...
  faq: [
    {
      ...
      answer:
        "Yes. All invited attendees are invited to the church ceremony and lunch buffet. Dinner invitations are separate."
    },
    {
      question: "What should I wear?",
      answer:
        "For church, smart casual or church wear is perfect. For dinner, semi-formal attire is recommended."
    },
    {
      question: "Can I change my RSVP after submitting?",
      answer:
        "Guests can view submitted RSVP details, but only admins can edit after submission. Please contact us if changes are needed."
    },
    {
      question: "How do I share dietary preferences?",
      answer:
        "The RSVP form includes dietary fields for church lunch attendees and dinner meal selections for dinner attendees."
    }
  ],
  contact: {
    title: "Contact Us",
